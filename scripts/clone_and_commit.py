...
if __name__ == "__main__":
    ...
    replacements = {
            ...
            "#EXTINF:-1,Bulgaria On Air": '#EXTINF:-1 tvg-name="bgonair.bg" tvg-logo="https://www.glebul.com/images/tv-logo/bulgaria-on-air.png" group-title="ЕФИРНИ" , Bulgaria ON Air HD.bg',
